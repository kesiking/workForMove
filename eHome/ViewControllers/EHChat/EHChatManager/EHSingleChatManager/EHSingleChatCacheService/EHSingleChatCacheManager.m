...
- (void)recieveBabyChatMessage:(EHChatMessageinfoModel *)message{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:EHRecieveSelectedBabyChatMessageNotification object:nil userInfo:@{EHBabyChatMessageModel_DATA:message}];
...
-(void)sendBabyChatMessageWithNetwork:(XHBabyChatMessage *)message
    ...
    switch (message.messageMediaType) {
        ...
        case XHBubbleMessageMediaTypePhoto: {
            context_type = EHMessageContextType_Emotion;
            context = message.text;
            break;
        }
