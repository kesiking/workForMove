...
- (void)repositionViews
{
    ...
    switch (_pageMode) {
        case JTCalendarPageModeFull:
            ...
            _leftView.frame = CGRectMake(0+self.frame.size.width / 14. - 8.5, 0, size.width, size.height);
            _centerView.frame = CGRectMake(size.width+self.frame.size.width / 14. - 8.5, 0, size.width, size.height);
            _rightView.frame = CGRectMake(size.width * 2+self.frame.size.width / 14. - 8.5, 0, size.width, size.height);
        ...
        case JTCalendarPageModeCenter:
            ...
            _leftView.frame = CGRectMake(- size.width+self.frame.size.width / 14. - 8.5, 0, size.width, size.height);
            _centerView.frame = CGRectMake(0+self.frame.size.width / 14. - 8.5, 0, size.width, size.height);
            _rightView.frame = CGRectMake(size.width+self.frame.size.width / 14. - 8.5, 0, size.width, size.height);
