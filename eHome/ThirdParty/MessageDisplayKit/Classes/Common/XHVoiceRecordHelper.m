...
+ (NSString *)getRecorderPath {
    ...
    recorderPath = [paths[0] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@-MySound", [dateFormatter stringFromDate:now]]];
    return recorderPath;
}

#pragma mark - 生成文件路径
+ (NSString*)getRecorderPathofType:(NSString *)_type{
    NSString* fileDirectory = [[[self getRecorderPath]
