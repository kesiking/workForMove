  ...
  overrideLineWidth:(NSNumber *)overrideLineWidth
{
    ...
    if (self) {
        ...
        _circle.zPosition     = 1;
        _circle.rasterizationScale=2.0*[UIScreen mainScreen].scale;
        ...
        _circleBackground.rasterizationScale=2.0*[UIScreen mainScreen].scale;
        _circleBackground.shouldRasterize=YES;

        //调换下面两行代码顺序 否则layer图层显示错误
